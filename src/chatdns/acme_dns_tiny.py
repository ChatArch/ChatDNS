...
def get_crt(account_key: str, csr: str,
            dns_update_callback: Callable[[str, str], Any],
            dns_cleanup_callback: Callable[..., Any],
    ...
    Args:
        ...
        dns_cleanup_callback: Callback(domain, token_value) to remove this DNS TXT record
    ...
    def _send_signed_request(url, payload):
        nonlocal log_nonce
        resp = requests.head(new_nonce_url, timeout=20)
    ...
    for auth_url in authorizations:
        ...
        # Call DNS update callback and always attempt value-specific cleanup.
        ...
        try:
            ...
            logger.info("Waiting 60s for DNS propagation...")
            time.sleep(60)
            ...
            dns_cleanup_callback(domain, txt_record_value)
